...
const exportToExcel = (data) => {
  ...
  const lastRow = range.e.r + 1; // XLSX rows are 0-indexed

  // Add credits in the first column of the next row
  const creditCell = `A${lastRow + 1}`;
  ws[creditCell] = {
    t: "s",
    v: `Generated by RPI Result Analyzer | Built With ❤️ By Abu Sayed (absyd.xyz) | RPICC (beta-rpicc.vercel.app) | ${new Date().toLocaleString()}`
  };
